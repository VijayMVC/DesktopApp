...
Public Class BillingHelp
    ...
    Private Sub SearchRecords()
        ...
        Else 'If ModeHelp = 5 Then
            strSQL = "SELECT Distinct Patient.PatientID,Name,BillingID As ReceiptNo,PatientBilling.UserCode as User from Patient,PatientBilling Where Patient.PatientID=PatientBilling.PatientID AND (  Name  LIKE '" + Me.TXTSEARCH.Text.Trim + "%' or Patient.PatientID LIKE '" + Me.TXTSEARCH.Text.Trim + "%' or BillingID LIKE '" + Me.TXTSEARCH.Text.Trim + "%' or PatientBilling.UserCode LIKE '" + Me.TXTSEARCH.Text.Trim + "%') ORDER BY BillingID DESC"
